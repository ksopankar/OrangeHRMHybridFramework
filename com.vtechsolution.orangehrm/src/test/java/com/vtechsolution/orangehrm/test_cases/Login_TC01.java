...
//		driver.findElement(By.xpath("//button[@type='submit']")).click();
	...
	public void verifyOrangeHrmLogoTC_02() throws InterruptedException {
		 extentTest = extent.createTest("verifyOrangeHrmLogoTC_02");
		...
		if (lp.verifyOrangeHrmlogo()) {
			...
			extentTest.pass("Orange Hrm Logo Verified...!!!");
		} else {
			extentTest.fail("Orenge Hrm logo Not Displayed....??");
	...
	public void VerifyOrangeHrmPageTitleTC_03() {
		extentTest = extent.createTest("VerifyOrangeHrmPageTitleTC_03");
		if (driver.getTitle().equals("OrangeHRM")) {

			Assert.assertTrue(true);
		//	System.out.println("Orange HRM Page Title Verified On Login Page...");
			extentTest.info("Orange HRM Page Title Verified On Login Page...");
		} else {
			extentTest.info("Orange HRM Page Title Verified On Login Page...");
	...
	public void verifyloginTestTC_01() throws InterruptedException {
		extentTest = extent.createTest("verifyloginTestTC_01");
		LoginPage lp = new LoginPage(driver);
